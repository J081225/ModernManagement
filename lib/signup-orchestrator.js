...
function welcomeEmailHtmlPS({ businessName, username, twilioPhone, plan, baseUrl }) {
  ...
  return [
    ...
    '<div style="font-size:0.78em;font-weight:700;color:#9a3412;text-transform:uppercase;letter-spacing:0.6px;margin-bottom:8px;">Your business phone number</div>',
    '<div style="font-size:1.6em;font-weight:800;color:#c2410c;letter-spacing:-0.3px;">' + escapeHtml(twilioPhone) + '</div>',
    '<div style="font-size:0.85em;color:#9a3412;margin-top:8px;line-height:1.4;">Share this number with your customers for texts and calls. Your AI handles routine booking questions and triages anything that needs you.</div>',
    '</div>',
    // What happens next
    '<h2 style="font-size:1em;color:#2d3748;margin:24px 0 8px;">What happens next</h2>',
...
function welcomeEmailTextPS({ businessName, username, twilioPhone, plan, baseUrl }) {
  ...
  return [
    ...
    '  ' + twilioPhone,
    '',
    'Share this number with your customers for texts and calls. Your AI handles routine booking questions and triages anything that needs you.',
    '',
    'WHAT HAPPENS NEXT',
