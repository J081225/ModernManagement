...
async function processInboundMessage({
  ...
  const systemPrompt = buildSystemPrompt({ workspace, contact, knowledge, upcomingCalendar, thread });
...
function buildSystemPrompt({ workspace, contact, knowledge, upcomingCalendar, thread }) {
  const lines = [];
