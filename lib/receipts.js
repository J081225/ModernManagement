...
<html><body style="margin:0;padding:0;background:#0d1117;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Helvetica,Arial,sans-serif;">
  <div style="max-width:560px;margin:0 auto;padding:32px;background:#0d1117;color:#e2e8f0;">
    <div style="border-bottom:1px solid #94a3b8;padding-bottom:16px;margin-bottom:24px;">
      ...
      <div style="color:#94a3b8;font-size:14px;">${L.receipt} #${txId} &middot; ${date}</div>
    </div>
    ...
    <table style="width:100%;border-collapse:collapse;border-top:1px solid #94a3b8;padding-top:8px;">
      <tr><td style="color:#94a3b8;padding:4px 0;">${L.subtotal}</td><td style="color:#e2e8f0;text-align:right;padding:4px 0;">${formatCents(transaction.subtotal_cents)}</td></tr>
      ${transaction.tax_cents ? `<tr><td style="color:#94a3b8;padding:4px 0;">${L.tax}</td><td style="color:#e2e8f0;text-align:right;padding:4px 0;">${formatCents(transaction.tax_cents)}</td></tr>` : ''}
      ${transaction.discount_cents ? `<tr><td style="color:#94a3b8;padding:4px 0;">${L.discount}</td><td style="color:#e2e8f0;text-align:right;padding:4px 0;">-${formatCents(transaction.discount_cents)}</td></tr>` : ''}
      ${transaction.tip_cents ? `<tr><td style="color:#94a3b8;padding:4px 0;">${L.tip}</td><td style="color:#e2e8f0;text-align:right;padding:4px 0;">${formatCents(transaction.tip_cents)}</td></tr>` : ''}
      <tr><td style="color:#f5e6d3;font-weight:bold;padding:8px 0;border-top:1px solid #94a3b8;">${L.total}</td><td style="color:#d4af37;font-weight:bold;text-align:right;padding:8px 0;border-top:1px solid #94a3b8;">${formatCents(transaction.total_cents)}</td></tr>
