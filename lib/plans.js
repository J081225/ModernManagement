...
const PLANS = {
  ...
  // ==========================================================================
  // E11: Professional Services tiers. All monthly-only at launch; the
  // annual-billing toggle is deferred. PM-shape limit keys (maxProperties,
  // maxUnits) are present-but-null so the existing plan-enforcement code
  // doesn't choke when it inspects them on a PS workspace — PS workspaces
  // don't use those concepts. PS-shape keys (maxAppointmentsPerMonth,
  // maxAIConversationsPerMonth, maxServices, maxInventoryItems,
  // maxKnowledgeBaseEntries) are informational for now; future enforcement
  // can hook them in without another schema/lib change.
  // ==========================================================================
  ...
  starter: {
    ...
    limits: {
      maxUsers: 1,
      aiCommandsPerDayPerUser: 50,
      reportsPerMonth: 10,
      // PM-shape keys — null so PM enforcement code passes through.
      maxProperties: null,
      maxUnits: null,
      maxContacts: 50,
      // PS-shape keys
      maxAppointmentsPerMonth: 150,
      maxAIConversationsPerMonth: 150,
      maxServices: 25,
      maxInventoryItems: 50,
      maxKnowledgeBaseEntries: 25
    },
    features: {
      broadcast: false,
      autoResponse: true, // AI auto-respond is core to PS
      apiAccess: false,
      multiUserCollaboration: false,
      dailyBriefing: false,
      customAITraining: false,
      dedicatedCSM: false,
      // PS-specific feature flags
  ...
  pro: {
    ...
    limits: {
      maxUsers: 1,
      aiCommandsPerDayPerUser: 200,
      reportsPerMonth: 50,
      maxProperties: null,
      maxUnits: null,
      maxContacts: null, // unlimited
      maxAppointmentsPerMonth: 600,
      maxAIConversationsPerMonth: 800,
      maxServices: null, // unlimited
      maxInventoryItems: 250,
      maxKnowledgeBaseEntries: null // unlimited
    },
    features: {
      broadcast: false,
      autoResponse: true,
  ...
  premium: {
    ...
    extraUserPrice: 0,
    limits: {
      maxUsers: 1, // multi-staff scheduling is a feature flag, not a seat count, in v1
      aiCommandsPerDayPerUser: 500,
      reportsPerMonth: null, // unlimited
      maxProperties: null,
      maxUnits: null,
      maxContacts: null,
    ...
    features: {
      ...
      vendorMessaging: true,
      customAppointmentFields: true,
      multiStaffScheduling: true,
      brandedSmsSenderId: true,
