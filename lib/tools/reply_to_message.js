      ...
      if (channel === 'sms') {
        const saved = await ctx.db.query(
          `INSERT INTO messages (user_id, resident, subject, category, text, status, folder, phone, direction, sent_by)
           VALUES ($1, $2, $3, 'sms', $4, 'sent', 'inbox', $5, 'outbound', 'ai')
           RETURNING id`,
        ...
        const saved = await ctx.db.query(
          `INSERT INTO messages (user_id, resident, subject, category, text, status, folder, email, direction, sent_by)
           VALUES ($1, $2, $3, 'email', $4, 'sent', 'inbox', $5, 'outbound', 'ai')
           RETURNING id`,
