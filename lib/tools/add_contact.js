...
registry.register({
  name: 'add_contact',
  description: 'Add a new contact to the workspace. Contacts include customers (professional services), residents (property management), vendors, and important professional contacts. Captures name, type, optional contact info, and (for residents) lease details.',
  vertical: 'core',
  category: 'create',
  schema: {
    type: 'object',
    properties: {
      ...
      contact_type: { type: 'string', enum: ['customer', 'resident', 'vendor', 'important'], description: "Type of contact. Use 'customer' for professional-services clients, 'resident' for property-management tenants." },
