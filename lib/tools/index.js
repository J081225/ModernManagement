...
// BG5: money-out via the brain — approval-gated expense posting.
require('./post_expense');

// LS: mid-call spoken language switch (voice channel only, explicit
// request only; Arabic gated solely by ARABIC_VOICE_ENABLED).
