        ...
        const r = await ctx.db.query(
          `INSERT INTO transactions
             (workspace_id, contact_id, appointment_id, customer_display_name,
              ...
              payment_received_at)
           VALUES ($1,$2,$3,$4,$5::jsonb,$6,$7,$8,$9,$10,$11,'appointment_completion',$12,
             CASE WHEN $11 IN ('paid','partially_paid') THEN NOW() ELSE NULL END)
           RETURNING id`,
          [ctx.workspace.id, a.contact_id, appointment_id, customerName,
           JSON.stringify(lineItems), subtotal, tip, total, paid,
           pm, status, ctx.user.id]
        );
