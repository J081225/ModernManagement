...
const TOOL_CATEGORY = {
  ...
  // BG5: expense posting rides the VISIBLE payments lane (see
  // lib/tools/post_expense.js header for the reasoning) — approval-
  // gated, so act can never execute it anyway.
  post_expense: 'payments',
};
