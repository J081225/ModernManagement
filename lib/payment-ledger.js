...
// completes.
async function completePendingPayment(pool, processor, processorRef) {
...
async function processSquarePaymentCompleted(pool, { orderId, merchantId, amountCents, currency }) {
  ...
  return completePendingPayment(pool, 'square', orderId);
}
